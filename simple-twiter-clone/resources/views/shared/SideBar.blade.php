 <!-- Navigation Links -->
<!-- Component Start -->
<div class=" overflow-hidden text-gray-400 bg-gray-900 rounded">
   ...
   <a class="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-700 hover:text-gray-300" href="{{route('user.profile',auth()->user()->id)}}">
