        ...
        <div class="container px-6 h-16 flex justify-between items-center lg:items-stretch mx-auto">
            <div class="flex items-center">
                ...
                <ul class="hidden xl:flex items-center h-full">
                    ...
                    <li class="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 mx-10 tracking-normal transition duration-150 ease-in-out">
                        <span class="mr-2">
                    ...
                    <li class="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 mr-10 tracking-normal transition duration-150 ease-in-out">
                        <span class="mr-2">
                    ...
                    <li class="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 tracking-normal transition duration-150 ease-in-out">
                        <span class="mr-2">
            ...
            <div class="h-full hidden xl:flex items-center justify-end">
                <div class="h-full flex">
                    ...
                    <div class="w-20 h-full flex items-center justify-center border-l border-r border-gray-300 text-gray-400">
                    ...
                    <div class="w-20 h-full flex items-center justify-center border-r border-gray-300 cursor-pointer text-gray-400">
                            ...
                            <div class="mt-6 flex w-full items-center justify-between">
                                <div class="flex items-center justify-between w-full">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-base md:text-2xl text-gray-800 ml-3">The North</p>
                                    </div>
                                ...
                                <a class="cursor-pointer">
                                    <li class="text-gray-800 pt-8">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-indigo-700 xl:text-base text-base ml-3">Dashboard</p>
                                        </div>
                                    </li>
                                </a>
                                <a class="cursor-pointer">
                                ...
                                <a class="cursor-pointer">
                                    <li class="text-gray-800 pt-8">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Performance</p>
                                        </div>
                                    </li>
                                </a>
                                <li class="text-gray-800 pt-8 cursor-pointer">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Deliverables</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
...
<nav class="bg-gray-900">
    <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="relative flex items-center justify-between">
            ...
            <!-- Mobile menu -->
            <div class="lg:hidden">
                <button id="menu-toggle" aria-label="Open Menu" title="Open Menu" class="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline">
                ...
                <div id="mobile-menu" class="absolute top-0 left-0 w-full hidden z-10">
                    <div class="p-5 bg-white border rounded shadow-sm">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div>
                                <button id="menu-close" aria-label="Close Menu" title="Close Menu" class="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                                    <svg class="w-5 text-gray-600" viewBox="0 0 24 24">
